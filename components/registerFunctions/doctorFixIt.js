...
const doctorFixIt = async (req, res) => {
    const client = await pool.connect();
    try {
        console.log("[DOCTOR FIX IT] Registration request");
        ...
        handleRegistrationError(error, res, "Doctor Fix It");
    } finally {
        client.release();
    }
}

module.exports = doctorFixIt;